...
|---|---|---|---|---|---|
| 2026-09-20 | `12.0.14-dingtalk.8.325dfdcd` | 8 | `a0fe6349…a65f5d25489` | `sha256:f604d0ba…c55c013ba` | **当前生产用**。提交身份改为 GitHub noreply 后重导补丁（run 35500160361，手动触发）。镜像内容与上一版**未变**——三层指纹逐字节相同 |
| 2026-09-20 | `12.0.14-dingtalk.8.e9313643` | 8 | `a0fe6349…a65f5d25489` | `sha256:a9d840d6…42e584a4` | **当前生产用**。运维脚本烘进镜像（不再 bind-mount），生产 compose 已无宿主机相对路径（run 35497571764）。`.env.prod.example` 钉的就是这个 digest |
