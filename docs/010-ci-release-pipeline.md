...
|---|---|---|---|---|---|
| 2026-09-20 | `12.0.14-dingtalk.8.4261dd78` | 8 | `a0fe6349…a65f5d25489` | `sha256:c3b12c34…d01952d2` | **当前生产用**。含反代模式 nginx 修复；tag 规则改内容寻址后的首次发布（run 35496784127）。`.env.prod.example` 钉的就是这个 digest |
